...
import com.example.instagramclonedemo.common.components.CustomDialog
import com.example.instagramclonedemo.common.components.ImageDialog
import com.example.instagramclonedemo.common.components.PersonCard
import com.example.instagramclonedemo.common.components.StoryCard
                            ...
                            Row (
                                ...
                                AnimatedVisibility(visible = dismissState.targetValue == SwipeToDismissBoxValue.StartToEnd){
                                    Row (
                                        ...
                                        IconButton(onClick = {
                                            firebaseViewModel.addUserToFavorites(userData.email.toString(),ctx)
